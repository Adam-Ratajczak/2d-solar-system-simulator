...
void ArrowButton::draw(sf::RenderWindow& window) const {
    ...
    const sf::Vector2f points[8] = {
        sf::Vector2f(midpoint.x - m_arrow_size / 2, midpoint.y - m_arrow_size / 2),
        sf::Vector2f(midpoint.x + 0, midpoint.y - m_arrow_size / 2),
        sf::Vector2f(midpoint.x + m_arrow_size / 2, midpoint.y - m_arrow_size / 2),
        sf::Vector2f(midpoint.x - m_arrow_size / 2, midpoint.y + 0),
        sf::Vector2f(midpoint.x + m_arrow_size / 2, midpoint.y + 0),
        sf::Vector2f(midpoint.x - m_arrow_size / 2, midpoint.y + m_arrow_size / 2),
        sf::Vector2f(midpoint.x + 0, midpoint.y + m_arrow_size / 2),
        sf::Vector2f(midpoint.x + m_arrow_size / 2, midpoint.y + m_arrow_size / 2)
